...
* **Pass/Fail Assertion:** After 500 consecutive update cycles, the test checks that all four hardware registers converge within $\vert{}w_i - W^*_i\vert{} \le 10\text{ LSB}$ to account for truncated intermediate precision.
